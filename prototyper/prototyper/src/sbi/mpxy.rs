    ...
    fn read_channel_attrs(&self, channel_id: u32, base: u32, count: u32, out: &mut [u8]) -> bool {
        for i in 0..count {
            ...
            let value = match attr {
                ...
                channel_attr::MSG_SEND_TIMEOUT => crate::rpmi::RPMI_DEF_TX_TIMEOUT,
                channel_attr::MSG_COMPLETION_TIMEOUT => crate::rpmi::RPMI_DEF_RX_TIMEOUT,
...
impl rustsbi::Mpxy for SbiMpxy {
    ...
    fn set_shmem(&self, shmem: SharedPtr<u8>, flags: usize) -> SbiRet {
        ...
        self.shmem_hart()
            .store(shmem.phys_addr_lo(), Ordering::Release);
        SbiRet::success(0)
    }
